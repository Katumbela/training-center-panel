...
if (isset($_SESSION['id'])) {
    ...
    exit; // Certifique-se de sair do script após o redirecionamento
          ...
          $sql2 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual2}' AND codigo LIKE '%SDQ{$centro4}@%' AND tipo_operacao = 'entrada'";
        ...
        // Consulta SQL para somar os valores com a data de hoje
        $sql3 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual3}' AND codigo LIKE '%SDQ{$centro4}@%' AND tipo_operacao = 'saida'";
        ...
        $totalGeral4 = $totalE4 - $totalS4;

        $centro1 = 1;
$dataAtual = date('Y-m-d');

// Consulta SQL para somar os valores de entrada com a data de hoje para o Centro 1
$sqlEntrada1 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro1}@%' AND tipo_operacao = 'entrada'";
$resultadoEntrada1 = $conexao->query($sqlEntrada1);
$totalEntrada1 = 0;

if ($resultadoEntrada1 && $resultadoEntrada1->num_rows > 0) {
    $rowEntrada1 = $resultadoEntrada1->fetch_assoc();
    $totalEntrada1 = $rowEntrada1['total'];
}

// Consulta SQL para somar os valores de saída com a data de hoje para o Centro 1
$sqlSaida1 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro1}@%' AND tipo_operacao = 'saida'";
$resultadoSaida1 = $conexao->query($sqlSaida1);
$totalSaida1 = 0;

if ($resultadoSaida1 && $resultadoSaida1->num_rows > 0) {
    $rowSaida1 = $resultadoSaida1->fetch_assoc();
    $totalSaida1 = $rowSaida1['total'];
}

$totalGeral1 = $totalEntrada1 - $totalSaida1;


$centro2 = 2;
$dataAtual = date('Y-m-d');

// Consulta SQL para somar os valores de entrada com a data de hoje para o Centro 2
$sqlEntrada2 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro2}@%' AND tipo_operacao = 'entrada'";
$resultadoEntrada2 = $conexao->query($sqlEntrada2);
$totalEntrada2 = 0;

if ($resultadoEntrada2 && $resultadoEntrada2->num_rows > 0) {
    $rowEntrada2 = $resultadoEntrada2->fetch_assoc();
    $totalEntrada2 = $rowEntrada2['total'];
}

// Consulta SQL para somar os valores de saída com a data de hoje para o Centro 2
$sqlSaida2 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro2}@%' AND tipo_operacao = 'saida'";
$resultadoSaida2 = $conexao->query($sqlSaida2);
$totalSaida2 = 0;

if ($resultadoSaida2 && $resultadoSaida2->num_rows > 0) {
    $rowSaida2 = $resultadoSaida2->fetch_assoc();
    $totalSaida2 = $rowSaida2['total'];
}

$totalGeral2 = $totalEntrada2 - $totalSaida2;


$centro5 = 5;
$dataAtual = date('Y-m-d');

// Consulta SQL para somar os valores de entrada com a data de hoje para o Centro 5
$sqlEntrada5 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro5}@%' AND tipo_operacao = 'entrada'";
$resultadoEntrada5 = $conexao->query($sqlEntrada5);
$totalEntrada5 = 0;

if ($resultadoEntrada5 && $resultadoEntrada5->num_rows > 0) {
    $rowEntrada5 = $resultadoEntrada5->fetch_assoc();
    $totalEntrada5 = $rowEntrada5['total'];
}

// Consulta SQL para somar os valores de saída com a data de hoje para o Centro 5
$sqlSaida5 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro5}@%' AND tipo_operacao = 'saida'";
$resultadoSaida5 = $conexao->query($sqlSaida5);
$totalSaida5 = 0;

if ($resultadoSaida5 && $resultadoSaida5->num_rows > 0) {
    $rowSaida5 = $resultadoSaida5->fetch_assoc();
    $totalSaida5 = $rowSaida5['total'];
}

$totalGeral5 = $totalEntrada5 - $totalSaida5;


$centro3 = 3;
$dataAtual = date('Y-m-d');

// Consulta SQL para somar os valores de entrada com a data de hoje para o Centro 3
$sqlEntrada3 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro3}@%' AND tipo_operacao = 'entrada'";
$resultadoEntrada3 = $conexao->query($sqlEntrada3);
$totalEntrada3 = 0;

if ($resultadoEntrada3 && $resultadoEntrada3->num_rows > 0) {
    $rowEntrada3 = $resultadoEntrada3->fetch_assoc();
    $totalEntrada3 = $rowEntrada3['total'];
}

// Consulta SQL para somar os valores de saída com a data de hoje para o Centro 3
$sqlSaida3 = "SELECT SUM(valor) AS total FROM operacoes WHERE DATE(data_operacao) = '{$dataAtual}' AND codigo LIKE '%SDQ{$centro3}@%' AND tipo_operacao = 'saida'";
$resultadoSaida3 = $conexao->query($sqlSaida3);
$totalSaida3 = 0;

if ($resultadoSaida3 && $resultadoSaida3->num_rows > 0) {
    $rowSaida3 = $resultadoSaida3->fetch_assoc();
    $totalSaida3 = $rowSaida3['total'];
}

$totalGeral3 = $totalEntrada3 - $totalSaida3;
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <span class="text-secondary fs-6">Seja Benvindo ao painel Administrativo <?=$nome?></span></h3>
                                <ul class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div onclick="link('invoices?centro=1')" class="col-xl-3 col-sm-6 col-12 d-flex">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Rendimento de hoje (Centro 1)</h6>
                                        <h3><?=number_format($totalGeral1, 2, ',', '.') . ' Kz'?></h3>
                                    </div>
                                    <div class="db-icon">
                    ...
                    <div onclick="link('invoices?centro=2')" class="col-xl-3 col-sm-6 col-12 d-flex">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Rendimento de hoje (Centro 2)</h6>
                                        <h3><?=number_format($totalGeral2, 2, ',', '.') . ' Kz'?></h3>
                                    </div>
                                    <div class="db-icon">
                                        <img src="assets/img/icons/dash-icon-04.svg" alt="Dashboard Icon">
                                    </div>
                    ...
                    <div onclick="link('invoices?centro=3')" class="col-xl-3 col-sm-6 col-12 d-flex">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Rendimento de hoje (Centro 3)</h6>
                                        <h3><?=number_format($totalGeral3, 2, ',', '.') . ' Kz'?></h3>
                                    </div>
                                    <div class="db-icon">
                                        <img src="assets/img/icons/dash-icon-04.svg" alt="Dashboard Icon">
                                    </div>
                    ...
                    <div onclick="link('invoices?centro=4')" class="col-xl-3 col-sm-6 col-12 d-flex">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Rendimento de hoje (Centro 4)</h6>
                                        <h3><?=number_format($totalGeral4, 2, ',', '.') . ' Kz'?></h3>
                                    </div>
                                    <div class="db-icon">
                                        <img src="assets/img/icons/dash-icon-04.svg" alt="Dashboard Icon">
                                    </div>
                    ...
                    <div onclick="link('invoices?centro=5')" class="col-xl-3 col-sm-6 col-12 d-flex">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Rendimento de hoje (Centro 5)</h6>
                                        <h3><?=number_format($totalGeral5, 2, ',', '.') . ' Kz'?></h3>
                                    </div>
                                    <div class="db-icon">
                                        <img src="assets/img/icons/dash-icon-04.svg" alt="Dashboard Icon">
                                    </div>
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12">
                                                ...
                                                <a class="btn btn-primary my-3" href="relatorios?centro=<?=$_GET['centro'] == null ? $centro : $_GET['centro'] ?>">Ver Relatorios <div class="fas fa-arrow-right"></div></a>
